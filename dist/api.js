const BASE_URL = 'https://dados-abertos.apps.tcu.gov.br/api/acordao/recupera-acordaos';
const BATCH_SIZE = 100;
async function fetchBatch(inicio) {
 ...
 */
export async function fetchAllFrom(inicio, onProgress) {
    const all = [];
    let offset = inicio;
    while (true) {
